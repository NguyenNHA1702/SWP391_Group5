    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-12 mb-4">
                ...
                <form method="get" action="browse" class="mb-3 d-flex gap-2">
                    <input type="text" name="campaignTitle" placeholder="Tìm tiêu đề chiến dịch"
                           value="<%= request.getParameter("campaignTitle") != null ? request.getParameter("campaignTitle") : "" %>">
                    <select name="campaignSort">
            ...
            <div class="">
                ...
                <form method="get" action="browse" class="mb-3 d-flex gap-2">
                    <input type="text" name="productName" placeholder="Tìm tên sản phẩm"
