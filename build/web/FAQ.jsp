...
<body class="bg-gray-100 min-h-screen flex items-center justify-center py-8">
    ...
    String homeLink = (loggedUser != null) ? (request.getContextPath() + "/home") : "index.jsp";
                %>
            <a href="<%= homeLink %>"class="inline-block bg-blue-600 text-white py-2 px-6 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">Back to Create Campaign</a>
        </div>
