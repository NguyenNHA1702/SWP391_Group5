...
<body>
    <div class="container">
        ...
        <table class="status-table" id="campaignTable">
            ...
            <tbody>
                ...
                %>
                <tr data-title="<%= c.getTitle().toLowerCase() %>" data-status="<%= adminStatus %>" data-date="<%= submissionDate %>">
                    <td><%= c.getTitle() %></td>
    ...
    <script>
        function filterTable() {
            // Lấy giá trị từ ô tìm kiếm và bộ lọc
            ...
            rows.forEach(row => {
                ...
                // Chuyển đổi ngày từ định dạng "dd/MM/yyyy HH:mm" sang đối tượng Date
                let date = null;
                if (dateStr) {
