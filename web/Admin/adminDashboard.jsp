...
<head>
    ...
    <style>
        ...
        .icon-campaign { color: var(--icon-campaign); }
        .icon-users { color: var(--icon-users); }
        .icon-requests { color: var(--icon-requests); }
        .icon-notifications { color: var(--icon-notifications); }
        .icon-stats { color: var(--icon-stats); }
    </style>
</head>
<body>
