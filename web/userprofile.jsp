...
<body class="font-sans text-gray-800">
    <%
        ...
        try (Connection connection = DBUtil.getConnection()) {
            String sql = "SELECT username, name, email, phone, role, created_at FROM users WHERE user_id = ?"; // Loại bỏ address
    ...
    <main class="container mx-auto px-4 py-8">
        <div class="profile-container p-6 max-w-lg mx-auto">
            ...
            <form action="ResetPasswordServlet" method="post" id="passwordForm" class="mt-6" onsubmit="return validatePassword()">
                <h3 class="text-lg font-medium text-green-700 mb-2">Reset Password</h3>
                <div class="form-group">
                ...
                <button type="submit" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition">Reset Password</button>
            </form>
