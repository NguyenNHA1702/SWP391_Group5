...
public class MessageDAO {
    ...
    public List<Conversation> getConversations(int userId) throws SQLException, Exception {
    ...
    public List<Map<String, Object>> getMessages(int userId, int otherUserId) throws SQLException, Exception {
    ...
    public void markAsRead(int userId, int otherUserId) throws SQLException, Exception {
    ...
    public List<UserInfo> getUsers(int userId) throws SQLException, Exception {
    ...
    public void sendMessage(Message message) throws SQLException, Exception {
        String sql = "INSERT INTO messages (sender_id, receiver_id, content, language, is_read, sent_time) VALUES (?, ?, ?, ?, 0, GETDATE())";
        try (Connection conn = DBUtil.getConnection(); PreparedStatement stmt = conn.prepareStatement(sql)) {
    ...
    public int getUnreadCount(int userId) throws SQLException, Exception {
